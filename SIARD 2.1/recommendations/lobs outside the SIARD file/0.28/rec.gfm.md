...
1.  1.  1.  <span id="anchor-22"></span>**Limits for file amount and for
...
These folders are placed at the same top level to enable effective and easy file and folder handling.[]{#anchor-17}
